...
export const Navbar = () => {
    ...
    return (
        <div>
            <div className="md:block fixed w-full bg-black z-50 overflow-x-hidden text-white">
                <motion.nav
                    className="flex justify-between py-4 border-b border-white/10 lg:px-[3%] items-center w-full overflow-x-hidden z-10"
                    ...
                    <div className="flex space-x-8 items-center">
                        ...
                        {user ? (
                            <div className="flex items-center space-x-4">
                                ...
                                />
                                <motion.button
                                    className="cursor-pointer bg-gradient-to-b from-red-400 to-red-500 px-5 py-2 text-black flex items-center space-x-2 rounded-xl duration-300 hover:drop-shadow-[0_16px_24px_rgba(239,68,68,0.35)]"
                                    whileHover={{ y: -1 }}
                                    whileTap={{ scale: 0.9 }}
            ...
            <div className="md:hidden block h-[70px] fixed top-0 left-0 border-b border-white/10 w-full px-5 bg-[#0a0a0a] z-50 overflow-x-hidden">
