...
export const Hero = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-[100vh] relative">
            ...
            <motion.span className="absolute top-20 right-72 rounded-xl p-2 hidden lg:block"
                initial={{ y: 0, opacity: 0 }}
                animate={{
                    y: [0, -10, 0],
                    opacity: 1
            ...
            <motion.span className="absolute bottom-20 text-[#ff3c00] right-96 rounded-xl hidden lg:block"
                initial={{ y: 0, opacity: 0 }}
                animate={{
                    y: [0, -10, 0],
                    opacity: 1
            ...
            <motion.span className="absolute bottom-32 left-80 text-[#58c4dc] rounded-xl p-2 hidden lg:block"
                initial={{ y: 0, opacity: 0 }}
                animate={{
                    y: [0, -10, 0],
                    opacity: 1
