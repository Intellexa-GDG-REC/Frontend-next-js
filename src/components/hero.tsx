    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-center min-h-screen overflow-x-hidden ">
                <div className="relative md:px-52 md:py-36">
                    <motion.span className="absolute top-20 lg:left-12 rounded-xl lg:p-2 hidden lg:block"
                    ...
                    <motion.span className="absolute top-2 lg:right-16 rounded-xl lg:p-2 hidden lg:block"
                        initial={{ y: 0, opacity: 0 }}
                        animate={{
                            y: [0, -10, 0],
                            opacity: 1
                    ...
                    <motion.span className="absolute bottom-14 text-[#ff3c00] lg:right-14 rounded-xl hidden lg:block"
                        initial={{ y: 0, opacity: 0 }}
                        animate={{
                            y: [0, -10, 0],
                            opacity: 1
                    ...
                    <motion.span className="absolute bottom-4 lg:left-20 text-[#58c4dc] rounded-xl lg:p-2 hidden lg:block"
                        initial={{ y: 0, opacity: 0 }}
                        animate={{
                            y: [0, -10, 0],
                            opacity: 1
